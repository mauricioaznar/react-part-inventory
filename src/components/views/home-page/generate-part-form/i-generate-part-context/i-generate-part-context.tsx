...
type Part =  GetPartCategoriesQuery["getPartCategories"][number]["parts"][number] | null
...
export const GeneratePartContextProvider = (props: IGeneratePartContextProvider) => {
	...
	return <GeneratePartContext.Provider value={{ open, setOpen, part, setPart, mode, setMode}}>
		{ children }
